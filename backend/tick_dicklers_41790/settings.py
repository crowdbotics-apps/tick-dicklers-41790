"""
Django settings for tick_dicklers_41790 project.
...
ROOT_URLCONF = 'tick_dicklers_41790.urls'
...
WSGI_APPLICATION = 'tick_dicklers_41790.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "tick_dicklers_41790 API",
    "DESCRIPTION": "API documentation for tick_dicklers_41790 App",
    "VERSION": "v1",
}
